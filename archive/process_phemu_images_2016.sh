...
# Assign variables for processing the images for the fourth camera
#
imgLog05=`find ./Cam5 -maxdepth 2  -name "LogFile.txt"`
echo $imgLog05
imgFolder05=`echo $imgLog05 | cut -d'/' -f1-3`
...
imgLogP405=`find . -maxdepth 1  -name "*Cam5_LogFile_p4.txt"`
