...
CREATE TABLE `uas_run_new` (
  ...
  `utm_easting_x_min` double(255,7) DEFAULT NULL,
  `utm_easting_x_max` double(255,7) DEFAULT NULL,
  `utm_northing_y_min` double(255,7) DEFAULT NULL,
  `utm_northing_y_max` double(255,7) DEFAULT NULL,
  `lat_min` double(255,7) DEFAULT NULL,
  `lat_max` double(255,7) DEFAULT NULL,
  `long_min` double(255,7) DEFAULT NULL,
  `long_max` double(255,7) DEFAULT NULL,
