...
workon python_2_7_6
~/python2_programs/htp/rename_image_files_v02 -c $cameraID -a $apLogPath -d $imagePath
deactivate
#
...
source /usr/bin/virtualenvwrapper.sh
workon python_2_7_6
~/python2_programs/htp/create_uav_metadata_file_v03a -d $imagePath -c $cameraID -a $apLogPath -t CR2 -o $uasMetadata
deactivate
#
exit
